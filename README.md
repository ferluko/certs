...
```
## Get active certificate (string) from host
```
openssl s_client -showcerts -connect mydomain.com:443 < /dev/null 2> /dev/null | openssl x509
openssl s_client -showcerts -connect mydomain.com:443 < /dev/null 2> /dev/null | openssl x509 -noout -text
```
